...
import 'package:tapeats/presentation/screens/inventory_management/inventory_management_page.dart';
    ...
    if (_userRole == 'customer') {
      ...
      return [
        ...
        const InventoryManagementPage(
            selectedIndex: 2), // Placeholder for Reports
      ];
    } else if (_userRole == 'restaurant_chef') {
      return [
        const RestaurantHomePage(selectedIndex: 0),
      ...
      return [
        ...
        const ReceivedOrdersPage(
            selectedIndex: 3), // Placeholder for Reservations
      ];
    } else if (_userRole == 'restaurant_cashier') {
      return [
        const RestaurantHomePage(selectedIndex: 0),
      ...
      return [
        ...
        const InventoryManagementPage(
            selectedIndex: 4), // Placeholder for Reports
      ];
    } else {
