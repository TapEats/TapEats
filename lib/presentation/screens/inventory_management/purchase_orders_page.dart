...
class _PurchaseOrdersPageState extends State<PurchaseOrdersPage> {
        ...
        if (mounted) {
          final shouldCreate = await showDialog<bool>(
            ...
            builder: (context) => AlertDialog(
              ...
              title: const Text('Create Purchase Order Tables?',
          ...
          try {
            ...
            if (mounted) {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text(
                      'Failed to create purchase order tables. Please contact your administrator.'),
  ...
  void _filterOrders() {
    ...
    setState(() {
      _filteredOrders = _orders.where((order) {
        ...
        final orderId =
            order['purchase_order_id']?.toString().toLowerCase() ?? '';
        ...
        if (order['supplier_id'] is Map) {
          supplierName =
              order['supplier_id']['company_name']?.toString().toLowerCase() ??
                  '';
  ...
  void _showCreateOrderModal(BuildContext context) {
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              const Expanded(
                child: Text(
                    'You need to add inventory items before creating purchase orders.'),
              ),
              TextButton(
                onPressed: () {
                  ScaffoldMessenger.of(context).hideCurrentSnackBar();
    ...
    var selectedSupplierId =
        _suppliers.isNotEmpty ? _suppliers[0]['supplier_id'] : null;
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          TextButton.icon(
                            onPressed: () {
                              _showAddItemDialog(context, _inventoryItems,
                                  (item, quantity) {
                                setState(() {
                            ...
                            icon: const Icon(Iconsax.add,
                                color: Color(0xFFD0F0C0), size: 18),
                            label: const Text(
                              'Add Item',
                              style: TextStyle(color: Color(0xFFD0F0C0)),
                            ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            onPressed:
                                orderItems.isEmpty || selectedSupplierId == null
  ...
  void _showAddItemDialog(
    ...
    Map<String, dynamic>? selectedItem =
        inventoryItems.isNotEmpty ? inventoryItems[0] : null;
    double quantity = 1.0;
