...
import 'package:tapeats/presentation/screens/inventory_management/inventory_count_page.dart';
import 'package:tapeats/presentation/screens/inventory_management/purchase_orders_page.dart';
import 'package:tapeats/presentation/screens/inventory_management/receiving_page.dart';
import 'package:tapeats/presentation/screens/inventory_management/recipe_costs_page.dart';
import 'package:tapeats/presentation/screens/inventory_management/stock_management_page.dart';
import 'package:tapeats/presentation/screens/inventory_management/suppliers_management_page.dart';
import 'package:tapeats/presentation/screens/inventory_management/waste_management_page.dart';
  ...
  Future<void> _fetchInventoryStats() async {
    ...
    try {
      ...
      try {
        ...
        _lowStockCount = lowStockResult
            .where((item) =>
                item['min_quantity'] != null &&
                item['quantity'] != null &&
                (item['quantity'] as num) < (item['min_quantity'] as num))
            .length;
      } catch (e) {
      ...
      try {
        if (await _checkTableExists('inventory_transactions')) {
          ...
          if (lastCountResult.isNotEmpty) {
            final lastCountDate =
                DateTime.parse(lastCountResult[0]['created_at']);
            final now = DateTime.now();
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  _buildCategoryChip(
                      "Low Stock", _selectedCategory == "Low Stock"),
                  _buildCategoryChip(
                      "Expiring Soon", _selectedCategory == "Expiring Soon"),
                  _buildCategoryChip(
                      "Recent Orders", _selectedCategory == "Recent Orders"),
                ],
              ),
            ),
                          ...
                          _buildFeatureCard(
                            ...
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      const PurchaseOrdersPage(), // Replace with Purchase Orders page
                                ),
                              );
                            },
                          ),
                          _buildFeatureCard(
                            ...
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      const ReceivingPage(), // Replace with Receiving page
                                ),
                              );
                            },
                          ),
                          _buildFeatureCard(
                            ...
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      const InventoryCountPage(), // Replace with Inventory Count page
                                ),
                              );
                            },
                          ),
                          _buildFeatureCard(
                            ...
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      const WasteManagementPage(), // Replace with Waste page
                                ),
                              );
                            },
                          ),
                          _buildFeatureCard(
                            ...
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      const RecipeCostsPage(), // Replace with Recipe Costs page
                                ),
                              );
                            },
                          ),
