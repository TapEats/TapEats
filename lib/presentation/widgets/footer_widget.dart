  ...
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      child: Stack(
        ...
        children: [
          _selectedIndex >= 0 ? _buildInverseTriangle(_selectedIndex) : Container(), // Triangle image
          ...
          Stack(
            ...
            children: [
              ...
              AnimatedAlign(
                ...
                child: AnimatedContainer(
                  ...
                  transform: isSelected
                      ? Matrix4.translationValues(0, -40, 0)  // Circle rises with the icon
              ...
              AnimatedContainer(
                duration: _duration,
                transform: isSelected
                    ? Matrix4.translationValues(0, -40, 0)  // Icon rise animation
                    : Matrix4.translationValues(0, 0, 0),
                child: Icon(
                  iconData,
                  color: isSelected
